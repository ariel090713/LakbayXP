...
<div class="flex flex-col gap-8">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Sign in to your organizer dashboard</p>
    </div>
    ...
    <div class="relative">
        ...
        <div class="relative flex justify-center text-xs"><span class="bg-gray-50 px-4 text-gray-400">or sign in with email</span></div>
    </div>

    <form wire:submit="login" class="flex flex-col gap-5">
        <div>
            <label for="email" class="block text-sm font-medium text-gray-700 mb-1.5">Email address</label>
            <input wire:model="email" id="email" type="email" name="email" required autofocus autocomplete="email"
        ...
        <div>
            <div class="flex items-center justify-between mb-1.5">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-xs text-emerald-600 hover:text-emerald-700 font-medium" wire:navigate>Forgot password?</a>
                @endif
            </div>
        ...
        <label class="flex items-center gap-2 cursor-pointer">
            <input wire:model="remember" type="checkbox" class="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500" />
    ...
    <div class="text-center">
        <p class="text-sm text-gray-500">
            ...
            <a href="{{ route('register') }}" class="font-semibold text-emerald-600 hover:text-emerald-700" wire:navigate>Register as Organizer</a>
        </p>
    </div>
</div>
